...
<!-- Mirrored from andit.co/projects/html/andshop/andshop-dashboard/invoice.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Feb 2023 08:14:43 GMT -->
<head>
	<meta charset="utf-8" />
										...
										<table id="responsive-data-table" class="table" style="width:100%">
											...
											<tbody>
												<tr>
													...
													<td>$12,200</td>
													<td>Credit card</td>
													<td> <span class="badge badge-success">Payment accepted</span> </td>
													<td>
